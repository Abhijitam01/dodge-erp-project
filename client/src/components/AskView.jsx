...
function DataLineagePanel({ results, onExploreGraph }) {
  ...
  return (
    <div className="border border-gray-200 rounded-xl p-4 w-full sm:w-64 sm:shrink-0">
...
export default function AskView({ onHighlight, initialQuery, onExploreGraph }) {
  ...
  function handleSaveResult() {
    ...
    const entry = {
      ...
      chartRows: result.results ? result.results.slice(0, 20) : [],
      strKey: chartData?.strKey ?? null,
      numKey: chartData?.numKey ?? null,
  ...
  return (
    <div className="flex-1 overflow-y-auto px-4 py-6 sm:px-8 sm:py-8 max-w-4xl mx-auto w-full">
      <div className="flex items-center justify-between mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Ask your data</h1>
        <div className="flex items-center gap-2">
          <div className="relative">
            ...
            {showHistory && history.length > 0 && (
              <div className="absolute right-0 top-10 w-64 sm:w-80 bg-white border border-gray-200 rounded-xl shadow-lg z-50 overflow-hidden">
          ...
          <div className="flex items-center justify-between px-5 py-3.5 border-b border-gray-100">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1 text-xs font-medium text-gray-700 border border-gray-200 rounded-full hover:bg-gray-50 transition-colors"
              >
                {chartSavedToast ? (
          ...
          {result.nodeIds?.length > 0 && onExploreGraph && (
            <div className="px-5 pb-3 -mt-1">
              ...
              >
                ...
                {result.nodeIds.length} node{result.nodeIds.length !== 1 ? 's' : ''} highlighted — View on graph →
              </button>
            </div>
          )}
